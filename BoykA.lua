...
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "J_ax_s_o_N")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
...
if BoykArt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..result.title_.."](t.me/"..(text1[3] or "J_ax_s_o_N")..")".."\n✫: تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- 𝒋𝒂𝒙𝒔𝒐𝒏 sᴏᴜʀᴄʀ .',url="t.me/J_ax_s_o_N"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,msg.id_,'✫: شترك في قناة السورس اولآ @J_ax_s_o_N .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ 𝒋𝒂𝒙𝒔𝒐𝒏\n\n[-  𝒋𝒂𝒙𝒔𝒐𝒏 ᴄʜᴀɴɴᴇʟ  .](t.me/J_ax_s_o_N)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/JAXSO0N)\n\n[-  𝒋𝒂𝒙𝒔𝒐𝒏 ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/
M0o_oO_DY_2bot)\n\n[-  ʙᴏᴛ 𝒋𝒂𝒙𝒔𝒐𝒏 .](http://t.me/
M0o_oO_DY_2bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: 𝒋𝒂𝒙𝒔𝒐𝒏 sᴏᴜʀᴄʀ .',url="t.me/J_ax_s_o_N"}},
...
inline = {
{{text = '✫:  - sᴏᴜʀᴄʀ 𝒋𝒂𝒙𝒔𝒐𝒏  .',url='http://t.me/J_ax_s_o_N'}},
}
